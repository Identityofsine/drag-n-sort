...
var Draggable = function (_a) {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { ref: container_ref, onMouseDown: function (e) { if (!drag_only_button)
            onMouseDown(e); }, className: "grabbable ".concat(drag_only_button ? 'button-only' : '', " id-grabbable-").concat(section_id ? section_id : "all", " relative"), children: [(0, jsx_runtime_1.jsx)("div", { ref: ref, style: { position: 'relative' }, children: props.children }), drag_only_button &&
                (0, jsx_runtime_1.jsx)("div", { className: "drag-button", onMouseDown: onMouseDown, children: props.drag_button }), (0, jsx_runtime_1.jsx)("div", { ref: ghost_ref, className: "ghost ".concat(holding ? "active" : "") })] }));
};
